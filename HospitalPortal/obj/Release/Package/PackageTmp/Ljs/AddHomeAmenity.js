...
$("#addNewbt").click(function () {
    ...
    nextRow.find("td").last().html('<span class="btn btn-danger" id="btnDelete"><i class="fa fa-trash-o"></i></span>');
    table.append(nextRow);
});

// deleting attribue
$("#HomeAmenity").on("click", "#btnDelete", function () {
    var btn = $(this);
